...
import { CreateLocalSong } from '@simple-music/interfaces';

export class CreateSongDto implements CreateLocalSong {
  @ApiProperty({ description: 'Назва пісні (для локальних)' })
  @IsString()
  title!: string;
